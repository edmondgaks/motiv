    ...
    return (
        <div className="w-full flex flex-col min-h-screen text-[#242731] justify-center items-center">
            <div className="flex flex-col gap-6 justify-center">
                ...
                <p className="text-sm text-gray-400">Don't have an account? <span className="text-[#A162F7]">Sign up</span></p>
                ...
                <div className="bg-white flex flex-col gap-6 shadow-lg rounded-lg p-4">
                    <div className="flex flex-col justify-center gap-2">
                        ...
                        <input type="email" name="fname" className="w-full border border-[#B1B5C3] rounded-md py-3 px-4" placeholder="uistore@gmail.com" />
                    </div>
                    <div className="flex flex-col justify-center gap-2">
                        <h1 className="text-sm font-medium text-black">Password</h1>
                        <input type="password" name="fname" className="w-full border border-[#B1B5C3] rounded-md py-3 px-4" placeholder="********" />
                    </div>
                </div>
                ...
                <button className="text-center p-2 bg-[#A162F7] text-white rounded-lg text-semibold text-lg">Sign in</button>
            </div>
        </div>
    )
}
